...
PID_IMPORT_MAX_PARALLEL = 1200
PID_IMPORT_REQUEST_TIMEOUT = (5, 12)
PID_IMPORT_CACHE_WRITE_THREADS = 16
PID_IMPORT_FEED_PAGE_LIMIT = 100
PID_IMPORT_FEED_MAX_PAGE_WORKERS = 20
